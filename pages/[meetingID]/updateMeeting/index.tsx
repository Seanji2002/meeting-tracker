    ...
    return (
        <div className="w-full max-w-max">
            <form action="/api/sanityHandler" method="POST" className="w-full ml-20 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                <div className="mb-4">
                    <label htmlFor="meetingID" className="block text-gray-700 text-sm font-bold mb-2">Meeting ID (Read Only):</label>
                    <input type="text" id="meetingID" name="meetingID" value={meetingInfo._id} readOnly className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
                <div className="mb-4">
                ...
                <div className="mb-4">
                    ...
                    <textarea type="text" id="description" defaultValue={meetingInfo.description} name="description" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"/>
                </div>
